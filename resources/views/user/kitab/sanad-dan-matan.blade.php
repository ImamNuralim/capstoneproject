...
<head>
    ...
    <title>Sanad dan Matan | ElHadith</title>

    <link rel="stylesheet" href="{{ asset('assets/css/sanad.css') }}">
            ...
            <div class="row shadow">
                <div id="main_article" class="col-md-8 col-sm-12 col-xs-12 rounded-start sanad_main">
                    <div class="min-vh-100 mt-md-5 px-md-5 mt-4 px-4 text-center text-wrap">
                        ...
                        <div class="my-3">
                            <img class="img-fluid my-2 rounded-2 shadow" src="./assets/images/sanad_main_image.png"
                                alt="">
                        </div>
                        <p class="content">
