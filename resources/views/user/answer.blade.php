                ...
                <div class="row">
                    ...
                    <div class="mt-3">
                        <a href="#" class="text-dark" data-toggle="modal" data-target="#imageModal">
                            ...
                            <div class="image-container">
                                <img src="{{ asset('img/no-image.png') }}" class="img-fluid" style="max-width: 100%; height: auto;">
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <button wire:click="votes('up')"
                            class="btn btn-pill btn-outline-secondary ) active border-secondary ">
                            <div wire:loading.remove wire:target="votes('up')">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-down"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path
                        ...
                        <div class="float-end">
                            ...
                            <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#"
                                        wire:click.prevent="delete" wire:confirm="Delete answer?">
