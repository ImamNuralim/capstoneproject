                ...
                <div class="row">
                    <div class="col-1">
                        <span class="avatar rounded-circle" style="color: aquamarine, padding-left:5px">
                            <img class="avatar rounded-circle" src="{{ asset('assets/images/profile/user-1.jpg') }}" alt="">
                        </span>
                      </div>
                      <div class="col-11" style="padding-left:25px">
                        ...
                        <a class="no-underline" href="#" id="follow-btn" style="padding-left: 10px; position: relative;">
                            Follow
                        ...
                        <div class="text-secondary">
                            <a class="credential" href="">Universitas Diponegoro</a>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('post') }}"
                            class="text-dark"><b</b></a>
                    </div>

                    {{-- <div class="col-11" style="padding-left: 30px">
                        <a class="userrname" href="{{ route('profile.index', $answer->user->username_slug) }}" class="text-dark">
                        ...
                        @if (auth()->id() != $answer->user->id) &#8226;
                            ...
                            @else
                                <a href="#" style="font-size: 13px" wire:click.prevent="unfollow"
                                    class="text-secondary"> Following </a>
                            @endif
                        @endif
                        <div class="text-secondary" style="font-size: 13px">
                            ...
                            @if ($credential)
                                &#8226;
                            @endif <a href=""
                                class="text-secondary">{{ $answer->created_at->diffForHumans() }}</a>
                        </div>
                    </div> --}}
                </div>
                {{-- @if ($from == 'home')
