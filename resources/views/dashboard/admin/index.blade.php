...
<body>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <h2>Data <b>Admin</b></h2>
                            <a href="#tambahAdminModal" class="btn btn-primary" data-toggle="modal"><i
                                    class="material-icons">&#xE147;</i> <span>Tambah Admin Baru</span></a>

                            <a href="#deleteAdminModal" class="btn btn-danger" data-toggle="modal"><i
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>gustavo12</td>
                            <td>
                                <a href="#editAdminModal" class="edit" data-toggle="modal"><i
                                        class="material-icons" title="Edit">&#xE254;</i></a>
                                <a href="#deleteAdminModal" class="delete" data-toggle="modal"><i
    ...
    <div class="modal fade" id="recoverustazModal" tabindex="-1" aria-labelledby="recoverustazModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content" style="width: 1000px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="recoverustazModalLabel">Recover Admin</h5>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row "">
                                        <div class="col-sm-6">
                                            <a href="#restoreAdmintModal" class="btn btn-success"
                                                data-toggle="modal">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <p>Yakin ingin menghapus permanen Admin?/p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                        <input type="submit" class="btn btn-danger" value="Delete">
    ...
    <div id="restoreAdmintModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Recover Admin</h4>
                        <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <p>Yakin ingin recover Admin?</p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
