...
<body>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Sholat</td>
                            <td>
                                <a href="#editPostModal" class="edit" data-toggle="modal" title="View"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0-4 0"/><path d="M21 12q-3.6 6-9 6t-9-6q3.6-6 9-6t9 6"/></g></svg></a>
                                <a href="#deletePostModal" class="delete" data-toggle="modal" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16m-10 4v6m4-6v6M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-12M9 7V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3"/></svg></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <!-- Edit Modal HTML -->
    <div id="tambahPostModal" class="modal fade">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <p>Yakin ingin menghapus Post?</p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
    ...
    <div class="modal fade" id="recoverustazModal" tabindex="-1" aria-labelledby="recoverustazModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content" style="width: 1000px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="recoverustazModalLabel">Recover Post</h5>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row "">
                                        <div class="col-sm-6">
                                            <a href="#restorePosttModal" class="btn btn-success"
                                                data-toggle="modal">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>gustavo12</td>
                                            <td>
                                                <a href="#editPostModal" class="edit" data-toggle="modal"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <p>Yakin ingin menghapus permanen Post?/p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                        <input type="submit" class="btn btn-danger" value="Delete">
    ...
    <div id="restorePosttModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Recover Post</h4>
                        <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <p>Yakin ingin recover Post?</p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
