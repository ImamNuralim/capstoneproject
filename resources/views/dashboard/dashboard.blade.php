        ...
        <div class="page-wrapper mt-5" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6"
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <!-- Gunakan Flexbox pada Container -->
                    <div class="card-container">
                        <div class="card">
                            <div href="{{ route('dashboard.ustaz.index') }}" class="btn card-body text-center">
                                ...
                                <p class="card-text">15 Ustaz</p>
                            </div>
                        </div>
                        <div class="card">
                            <div href="#" class="btn card-body text-center">
